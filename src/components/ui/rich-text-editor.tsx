...
export function RichTextEditor({ value, onChange, placeholder }: RichTextEditorProps) {
  ...
  return (
    <div className="rounded-2xl border border-[rgb(var(--border))] bg-[var(--panel)] shadow-sm dark:bg-[rgb(var(--surface-elevated))] dark:shadow-none dark:ring-1 dark:ring-[rgb(var(--border))]">
      ...
      <div
        ...
        className="min-h-[180px] px-4 py-3 text-sm text-[var(--text)] outline-none [&:empty:before]:text-[rgb(var(--text-tertiary))] [&:empty:before]:content-[attr(data-placeholder)]"
      />
    </div>
  );
}
