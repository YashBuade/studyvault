      ...
      <main className="relative overflow-hidden">
        ...
        <section className="px-4 pb-14 pt-16 sm:px-6 sm:pt-24 lg:px-8">
          <div className="mx-auto max-w-5xl text-center animate-fade-in">
            <h1 className="text-balance text-5xl font-bold tracking-tight text-[rgb(var(--text-primary))] sm:text-6xl animate-slide-up">
              A focused workspace for student learning
            </h1>
            <p className="mx-auto mt-5 max-w-3xl text-lg text-[rgb(var(--text-secondary))] animate-slide-up animate-stagger-1">
