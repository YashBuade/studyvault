...
export default async function DashboardPage() {
  ...
  if (isNewWorkspace) {
    return (
      <div className="rounded-[var(--radius-xl)] border border-[rgb(var(--border))] bg-[linear-gradient(135deg,rgb(var(--color-primary-light))_0%,rgb(var(--surface))_48%,rgb(var(--color-info-light))_100%)] px-6 py-12 text-center shadow-[var(--shadow-md)] ring-1 ring-[rgb(var(--border)/0.55)]">
        <h1 className="text-3xl font-semibold text-[rgb(var(--text-primary))]">Welcome to StudyVault 👋</h1>
        <div className="mx-auto mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[rgb(var(--surface))] text-sm font-semibold text-[rgb(var(--primary))] shadow-[var(--shadow-sm)] ring-1 ring-[rgb(var(--border)/0.55)]">
          SV
        </div>
    ...
    <div className="space-y-7">
          ...
          {stats.map((stat) => {
            ...
            return (
              <Link
                key={stat.label}
                href={stat.href}
                className="group rounded-[var(--radius-lg)] border border-[rgb(var(--border))] bg-[rgb(var(--surface))] p-4 transition-all duration-[var(--transition-base)] hover:-translate-y-0.5 hover:shadow-[var(--shadow-md)] ring-1 ring-[rgb(var(--border)/0.55)]"
              >
                <div className="mb-4">
      ...
      <section className="grid gap-4 md:grid-cols-3">
        {smartInsights.map((insight) => {
          ...
          return (
            <article key={insight.title} className="rounded-[var(--radius-lg)] border border-[rgb(var(--border)/0.8)] bg-[rgb(var(--surface)/0.92)] p-5 shadow-[var(--shadow-sm)] ring-1 ring-[rgb(var(--border)/0.55)] backdrop-blur">
      ...
      <section className="grid gap-4 xl:grid-cols-2">
        <article className="rounded-[var(--radius-lg)] border border-[rgb(var(--border)/0.8)] bg-[rgb(var(--surface)/0.92)] p-5 shadow-[var(--shadow-sm)] ring-1 ring-[rgb(var(--border)/0.55)] backdrop-blur">
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <article className="overflow-hidden rounded-[var(--radius-lg)] border border-[rgb(var(--border)/0.8)] bg-[rgb(var(--surface)/0.92)] shadow-[var(--shadow-sm)] ring-1 ring-[rgb(var(--border)/0.55)] backdrop-blur">
